...
public class NIM extends JFrame implements ActionListener {
    ...
    private JLabel     labelNIK            = new JLabel("NIK"),
                       ...
                       labelPembuat        = new JLabel("Create by Diffa Azkhani || A12.2020.06496");
    ...
    public NIM() {
        ...
        //Menambahkan objek panel ( panelPegawai ) ke container frame
        getContentPane().add(paneTiket).setBackground(Color.GRAY);
